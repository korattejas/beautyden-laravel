...
class AdvanceAppointmentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $serviceIds = [];
            if(isset($servicesJson['services'])){
            ...
            $data = [
                ...
                'price'               => isset($servicesJson['summary']['grand_total']) ? $servicesJson['summary']['grand_total'] : $request->price,
                'discount_price'      => isset($servicesJson['summary']['discount_amount']) ? $servicesJson['summary']['discount_amount'] : $request->discount_price,
