...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::group(['middleware' => [AdminCheck::class]], function () {
        ...
        Route::get('service-master/export-excel', [ServiceMasterController::class, 'exportExcel'])->name('admin.service-master.export.excel');
        ...
        Route::post('appointments/update-payment-status', [AppointmentsController::class, 'updatePaymentStatus'])->name('admin.appointments.updatePaymentStatus');
