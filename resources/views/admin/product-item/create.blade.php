            ...
            <form method="POST" id="productForm" enctype="multipart/form-data">
                ...
                <div class="d-flex justify-content-between align-items-center mb-2">
                    ...
                    <div class="d-flex gap-1">
                        ...
                        <button type="submit" class="btn btn-primary px-3 shadow">Publish Product</button>
                    </div>
                </div>
                    ...
                    <div class="col-xl-5">
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body pt-2">
                                <div class="mb-1">
                                    ...
                                    <input type="text" name="name" class="form-control form-control-lg border-primary border-opacity-25" placeholder="e.g. Matte Lipstick" required>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6 mb-1"><label class="form-label">Price</label><div class="input-group"><span class="input-group-text">₹</span><input type="number" name="price" class="form-control" required></div></div>
                                    <div class="col-6 mb-1"><label class="form-label">Discount %</label><div class="input-group"><input type="number" name="discount_percentage" class="form-control" placeholder="0"></div></div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4 mb-1"><label class="form-label">Stock Qty</label><input type="number" name="stock_quantity" class="form-control" placeholder="0"></div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mb-1">
                                        ...
                                        <div class="form-check form-switch mt-50">
                                            <input class="form-check-input" type="checkbox" name="show_in_client_app" value="1" id="show_in_client_app">
                                ...
                                <div class="mb-1">
                                    ...
                                    <textarea name="short_description" class="form-control" rows="2" placeholder="Brief info..."></textarea>
                                </div>
                                <div class="mb-1">
                                    <label class="form-label">Full Description</label>
                                    <textarea name="description" class="form-control" rows="4" placeholder="Detailed info..."></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                                <h4 class="card-title">Product Gallery (Images/Videos)</h4>
                        ...
                        <div class="card shadow-sm border-0">
                            <div class="card-header border-bottom d-flex justify-content-between align-items-center">
                                <h4 class="card-title">Product Variants (Shades/Sizes)</h4>
