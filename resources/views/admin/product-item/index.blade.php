        ...
        <div class="content-wrapper">
            <div class="content-header row">
                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Product Items</a></li>
                                </ol>
                            </div>
                        </div>
                    </div>
                ...
                <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                    <a href="{{ route('admin.product-item.create') }}" class="btn btn-primary">
                        Add New Product
                    </a>
                </div>
            </div>
...
@section('footer_script_content')
    <script>
        ...
        const form_url = '/product-item';
        datatable_url = '/getDataProductItem';
