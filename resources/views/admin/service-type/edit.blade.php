        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Edit Service Type</h2>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <form method="POST" data-parsley-validate="" id="addEditForm" role="form">
                                        @csrf
                                        <input type="hidden" name="edit_value" value="{{$type->id}}">
                                        ...
                                        <div class="row row-sm">
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    <label>Image</label>
                                                    @if(isset($type->icon) && !empty($type->icon))
                                                        <div class="mb-3">
                                                            <img src="{{ asset('uploads/service-types/' . $type->icon) }}"
                                                                alt="Type Image" style="width: 250px; height: auto;" />
                                                        </div>
                                                    @endif
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="description" rows="4"
                                                        placeholder="{{trans('admin_string.description')}}">{{($type->description ?? '')}}</textarea>
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <select id="is_popular" name="is_popular" class="form-control" required>
                                                        ...
                                                        <option value="1" @if($type->is_popular == '1') selected @endif>
                                                            High Priority</option>
                                                        <option value="0" @if($type->is_popular == '0') selected @endif>
                                                            Low Priority</option>
                                                    </select>
                                                    <div class="valid-feedback"></div>
                                                </div>
                                            ...
                                            <div class="col-12 mt-2">
                                                <div class="form-group">
                                                    ...
                                                    <select id="is_new" name="is_new" class="form-control" required>
                                                        ...
                                                        <option value="1" @if($type->is_new == '1') selected @endif>
                                                            New</option>
                                                        <option value="0" @if($type->is_new == '0') selected @endif>
                                                            No</option>
                                                    </select>
                                                    <div class="valid-feedback"></div>
                                                </div>
