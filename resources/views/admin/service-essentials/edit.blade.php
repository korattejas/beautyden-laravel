                                ...
                                <form method="POST" data-parsley-validate="" id="addEditForm" role="form" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 mb-1">
                                            ...
                                            <div class="premium-file-input {{ $essential->icon ? 'has-preview' : '' }}">
                                                <div class="placeholder-content">
                                                    <i data-feather="image" class="mb-1" style="width: 40px; height: 40px; color: #6366f1;"></i>
                                                    <h5 class="fw-bold">Change Icon</h5>
                                                    <p class="text-muted small">Click to upload new image</p>
                                                </div>
                                                <input type="file" name="icon" onchange="updatePreview(this)">
                                            </div>
                                            <div class="file-preview mt-1" style="{{ $essential->icon ? '' : 'display:none' }}">
                                                @if($essential->icon)
                                                    <img src="{{ asset('uploads/essential/' . $essential->icon) }}" class="preview-media shadow-sm">
                                                @endif
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-12 text-end mt-2">
                                            <button type="submit" class="btn btn-primary px-3">Update Essential</button>
