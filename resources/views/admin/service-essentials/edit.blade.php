                                    ...
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <div class="form-group">
                                                <label>Title</label>
                                                <input type="text" name="title" class="form-control" value="{{ $essential->title }}" required>
                                        ...
                                        <div class="col-md-6 mt-2">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="type" class="form-control" value="{{ $essential->type }}">
                                                <div class="valid-feedback"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 mt-2">
                                            <div class="form-group">
                                                ...
                                                @if($essential->icon)
                                                    <img src="{{ asset('uploads/essential/' . $essential->icon) }}" class="mt-1 rounded" style="max-width: 100px;">
                                                @endif
                                                <div class="valid-feedback"></div>
                                            </div>
                                        </div>
