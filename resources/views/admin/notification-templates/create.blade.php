        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Create Notification Template</h2>
                                ...
                                <form id="main_form" class="form" method="POST" action="javascript:void(0);">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-2">
                                            <div class="form-group">
                                                <label for="event_name" class="form-label">System Event (Unique Code) <span class="text-danger">*</span></label>
                                                <input type="text" class="form-control" id="event_name" name="event_name" value="" placeholder="e.g. order_placed" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12 mt-3 text-end">
                                            ...
                                            <button type="submit" class="btn btn-primary" id="submit_btn">Save Template</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
