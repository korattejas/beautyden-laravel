                        ...
                        <div class="card shadow-sm border-0">
                            ...
                            <div class="card-body pt-2" id="banner-media-container">
                                <div class="banner-media-row mb-1 p-2 border rounded bg-light bg-opacity-50 position-relative">
                                    ...
                                    <div class="banner-desc-section" style="display: none;">
                                        <textarea name="banner[0][description]" class="form-control" rows="3" placeholder="Enter Description Banner..."></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
