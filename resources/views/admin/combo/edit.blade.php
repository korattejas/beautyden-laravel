                    ...
                    <div class="col-md-7">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Combo Image (Leave blank to keep current)</label>
                                    <input type="file" name="image" class="form-control">
                                    @if($combo->image)
                                        <img src="{{ asset('uploads/combos/' . $combo->image) }}" class="mt-2" style="max-width:150px;">
                                    @endif
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-md-5">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div id="default-services-section">
                        ...
                        <div class="text-end">
                            <button type="submit" class="btn btn-save shadow">Update Combo</button>
